...
class SignaturePad : public ISignaturePad {
   ...
   private:
      ...
      char * __stdcall DeviceProductName() { return STR_SCRIPTEL_MODEL; };
...
//      IConnectionPointContainer
   ...
   private:
      ...
      scriptel_device *pDevice;

      long lcdWidth,lcdHeight;

      static unsigned int __stdcall  signatureActivityMonitor(void *pv);

      static void signatureReportCallback(scriptel_device *pDevice,scriptel_input_report *pReport,unsigned char reportId,unsigned char *pReportBuffer,unsigned int reportLength);
