...
#include "SignaturePad.h"
   ...
   *ppv = NULL; 
   ...
   if ( riid == IID_IGPropertyPageClient )                   // 8-28-09: IS this a serious bug ?
      *ppv = static_cast<IGPropertiesClient*>(this);         // Why I was having problem with IGPropertyPageClient property pages ?
   else
