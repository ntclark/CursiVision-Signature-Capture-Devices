...
#include "TabletPC.h"
  ...
  TabletPC::_IEnumConnectionPoints::_IEnumConnectionPoints(TabletPC *pp,_IConnectionPoint **cp,int connectionPointCount) : 
  ...
  TabletPC::_IEnumConnectionPoints::~_IEnumConnectionPoints() { 
  for ( int k = 0; k < cpCount; k++ )
  ...
  HRESULT TabletPC::_IEnumConnectionPoints::QueryInterface(REFIID riid,void **ppv) {
  return pParent -> QueryInterface(riid,ppv);
  }

  unsigned long __stdcall TabletPC::_IEnumConnectionPoints::AddRef() {
  return pParent -> AddRef();
  }

  unsigned long __stdcall TabletPC::_IEnumConnectionPoints::Release() {
  return pParent -> Release();
  }


  HRESULT TabletPC::_IEnumConnectionPoints::Next(ULONG countRequested,IConnectionPoint **rgpcn,ULONG *pcFetched) {
  ULONG found;
  ...
  HRESULT TabletPC::_IEnumConnectionPoints::Skip(ULONG cSkip) {
  ...
  HRESULT TabletPC::_IEnumConnectionPoints::Reset() {
  enumeratorIndex = 0;
  return S_OK;
  }

  HRESULT TabletPC::_IEnumConnectionPoints::Clone(IEnumConnectionPoints **ppEnum) {
