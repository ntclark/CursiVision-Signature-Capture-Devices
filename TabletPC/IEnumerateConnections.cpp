...
#include "TabletPC.h"
  ...
  TabletPC::_IEnumerateConnections::_IEnumerateConnections(
            IUnknown* pHostObj,
            ULONG cConnections,
  ...
  STDMETHODIMP TabletPC::_IEnumerateConnections::QueryInterface(REFIID riid,void **ppv) {
  *ppv = NULL;
  ...
  *ppv = (LPVOID)this;
  ...
  STDMETHODIMP_(ULONG) TabletPC::_IEnumerateConnections::AddRef() {
  ...
  STDMETHODIMP_(ULONG) TabletPC::_IEnumerateConnections::Release() {
  ...
  STDMETHODIMP TabletPC::_IEnumerateConnections::Next(ULONG cReq,CONNECTDATA* paConnections,ULONG* pcEnumerated) {
...
//    if ( NULL != paConnections -> pUnk ) paConnections -> pUnk -> AddRef();
  ...
  STDMETHODIMP TabletPC::_IEnumerateConnections::Skip(ULONG cSkip) {
  ...
  STDMETHODIMP TabletPC::_IEnumerateConnections::Reset() {
  enumeratorIndex = 0;
  return S_OK;
  }
  ...
  STDMETHODIMP TabletPC::_IEnumerateConnections::Clone(IEnumConnections** ppIEnum) {
