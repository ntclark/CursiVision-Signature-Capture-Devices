...
#define ALLOC_CONNECTIONS  16
  ...
  TabletPC::_IConnectionPoint::_IConnectionPoint(TabletPC *pp) : 
     pParent(pp), 
     adviseSink(0),
     nextCookie(400),
  ...
  TabletPC::_IConnectionPoint::~_IConnectionPoint() {
  ...
  HRESULT TabletPC::_IConnectionPoint::QueryInterface(REFIID riid,void **ppv) {
  return pParent -> QueryInterface(riid,ppv);
  }


  STDMETHODIMP_(ULONG) TabletPC::_IConnectionPoint::AddRef() {
  return pParent -> AddRef();
  }

  STDMETHODIMP_(ULONG) TabletPC::_IConnectionPoint::Release() {
  return pParent -> Release();
  }


  STDMETHODIMP TabletPC::_IConnectionPoint::GetConnectionInterface(IID *pIID) {
  ...
  *pIID = IID_ISignaturePadEvents;
  ...
  STDMETHODIMP TabletPC::_IConnectionPoint::GetConnectionPointContainer(IConnectionPointContainer **ppCPC) {
  return pParent -> QueryInterface(IID_IConnectionPointContainer,(void **)ppCPC);
  }


  STDMETHODIMP TabletPC::_IConnectionPoint::Advise(IUnknown *pUnkSink,DWORD *pdwCookie) {
  ...
  *pdwCookie = nextCookie++;
  ...
  STDMETHODIMP TabletPC::_IConnectionPoint::Unadvise(DWORD dwCookie) {
  ...
  STDMETHODIMP TabletPC::_IConnectionPoint::EnumConnections(IEnumConnections **ppEnum) {
  ...
  *ppEnum = NULL;
  ...
  int TabletPC::_IConnectionPoint::getSlot() {
  ...
  int TabletPC::_IConnectionPoint::findSlot(DWORD dwCookie) {
