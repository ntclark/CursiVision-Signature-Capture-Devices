...
#include "SignaturePad.h"
  ...
  SignaturePad::_IEnumConnectionPoints::_IEnumConnectionPoints(SignaturePad *pp,_IConnectionPoint **cp,int connectionPointCount) : 
  ...
  SignaturePad::_IEnumConnectionPoints::~_IEnumConnectionPoints() { 
  for ( int k = 0; k < cpCount; k++ )
  ...
  HRESULT SignaturePad::_IEnumConnectionPoints::QueryInterface(REFIID riid,void **ppv) {
  return pParent -> QueryInterface(riid,ppv);
  }

  unsigned long __stdcall SignaturePad::_IEnumConnectionPoints::AddRef() {
  return pParent -> AddRef();
  }

  unsigned long __stdcall SignaturePad::_IEnumConnectionPoints::Release() {
  return pParent -> Release();
  }


  HRESULT SignaturePad::_IEnumConnectionPoints::Next(ULONG countRequested,IConnectionPoint **rgpcn,ULONG *pcFetched) {
  ULONG found;
  ...
  HRESULT SignaturePad::_IEnumConnectionPoints::Skip(ULONG cSkip) {
  ...
  HRESULT SignaturePad::_IEnumConnectionPoints::Reset() {
  enumeratorIndex = 0;
  return S_OK;
  }

  HRESULT SignaturePad::_IEnumConnectionPoints::Clone(IEnumConnectionPoints **ppEnum) {
